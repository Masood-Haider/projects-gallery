    ...
    <div className="mx-auto max-w-5xl px-4 sm:px-6 pb-20 pt-28 sm:pt-32">
      ...
      <div className="flex flex-col items-center gap-8 md:flex-row md:items-start md:gap-16">
        ...
        <div className="text-center md:text-left">
          ...
          <p className="mt-2 text-base font-light sm:text-lg font-light text-gold tracking-wide">
            Full-Stack Developer
          </p>
          <p className="mt-4 max-w-xl text-base sm:text-lg font-light text-charcoal leading-relaxed">
