  ...
  const row1 = [
    {
      ...
      color: "text-[#61DAFB]",
      icon: (
        <svg viewBox="-11.5 -10.23174 23 20.46348" className="w-14 h-14 md:w-16 md:h-16 mb-3 fill-current">
    ...
    },
    {
      ...
      color: "text-[#000000]",
      icon: (
        <svg viewBox="0 0 128 128" fill="currentColor" className="w-14 h-14 md:w-16 md:h-16 mb-3">
    ...
    },
    {
      ...
      color: "text-[#3178C6]",
      icon: (
        <svg viewBox="0 0 24 24" fill="currentColor" className="w-14 h-14 md:w-16 md:h-16 mb-3">
      ...
      <div ref={row1Ref} className="flex mb-12 w-[200%] md:w-[200%] hover:[&>div]:[animation-play-state:paused]">
        <div className="flex w-full animate-marquee gap-10 md:gap-20 items-center justify-around">
          {[...row1, ...row1, ...row1].map((skill, i) => (
            <div 
              key={`${skill.name}-${i}`} 
              className={`flex flex-col items-center justify-center ${skill.color} hover:text-gold transition-all duration-500 w-40 md:w-44 cursor-default group`}
            >
