  ...
  const row1 = [
    {
      ...
      color: "text-[#61DAFB]",
      icon: (
        <svg viewBox="-11.5 -10.23174 23 20.46348" className="w-8 h-8 md:w-9 md:h-9 fill-current flex-shrink-0">
    ...
    },
    {
      ...
      color: "text-[#000000]",
      icon: (
        <svg viewBox="0 0 128 128" fill="currentColor" className="w-8 h-8 md:w-9 md:h-9 flex-shrink-0">
    ...
    },
    {
      ...
      color: "text-[#3178C6]",
      icon: (
        <svg viewBox="0 0 24 24" fill="currentColor" className="w-8 h-8 md:w-9 md:h-9 flex-shrink-0">
  ...
  return (
    <div ref={containerRef} className="w-full max-w-full overflow-hidden px-0 md:px-0 py-10 sm:py-20 relative bg-base">
      ...
      <div ref={row1Ref} className="flex mb-12 w-[200%] md:w-[200%] hover:[&>div]:[animation-play-state:paused]">
        <div className="flex w-full animate-marquee gap-8 md:gap-14 items-center justify-around">
          {[...row1, ...row1, ...row1].map((skill, i) => (
            <div 
              key={`${skill.name}-${i}`} 
              className={`flex flex-row items-center justify-center gap-3 px-5 py-3 rounded-2xl border border-charcoal/10 bg-base/80 backdrop-blur-sm shadow-sm hover:border-gold/40 hover:shadow-md ${skill.color} hover:text-gold transition-all duration-300 cursor-default group shrink-0`}
            >
      ...
      <div ref={row2Ref} className="flex w-[200%] md:w-[200%] hover:[&>div]:[animation-play-state:paused]">
        <div className="flex w-full animate-marquee-reverse gap-8 md:gap-14 items-center justify-around">
